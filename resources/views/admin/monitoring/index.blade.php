...
<div class="mb-4 flex flex-wrap gap-2 items-center justify-between">
    <a href="{{ route('admin.ruang-ujian.index') }}" class="flex items-center gap-1 text-sm text-gray-600 hover:text-gray-800">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
        Kembali
    </a>
    <div class="flex gap-2">
        <a href="{{ route('admin.monitoring.export-excel', $ruang->id) }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
            Export Excel
        </a>
        <a href="{{ route('admin.monitoring.export-analisis', $ruang->id) }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2">
...
<form method="GET" class="mb-4 flex flex-wrap gap-2 items-end">
    ...
    <a href="{{ route('admin.monitoring.index', $ruang->id) }}" class="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg text-sm">Reset</a>
    @endif
</form>
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-blue-50 transition-colors">
                    ...
                    <td class="px-4 py-3 text-right">
                        <form method="POST" action="{{ route('admin.monitoring.reset', $ruang->id) }}" class="inline"
